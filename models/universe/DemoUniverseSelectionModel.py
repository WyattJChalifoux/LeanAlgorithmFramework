...
from models.universe.UniverseSelectionModel import UniverseSelectionModel
from itertools import groupby


class DemoUniverseSelectionModel(UniverseSelectionModel):
    ...
    def CreateUniverses(self, algorithm):
        ...
        for key, grp in groupby(self.symbols, lambda s: (s.ID.Market, s.SecurityType)):
            ...
            universeSymbol = Symbol.Create(f"manual-universe-selection-model-{securityTypeString}-{market}",
                                           securityType, market)
            ...
            config = SubscriptionDataConfig(type, universeSymbol, resolution, entry.DataTimeZone,
                                            entry.ExchangeHours.TimeZone, False, False, True)
